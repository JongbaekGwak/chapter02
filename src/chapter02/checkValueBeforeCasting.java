...
//		 byte 타입은 -128 ~ 127 까지의 데이터만 저장할 수 있음
		 int i = 128;
		 
//		 Byte는 byte 타입의 래퍼클래스
//		 byte는 자바의 기본 데이터 타입으로 사용되고 있으며, 기본데이터 타입은 데이터를 표시하는데 주로 사용되기 때문에 별다른 기능이 없음
//		 Byte는 기본 데이터 타입인 byte 타입에 몇가지 기능을 추가하여 클래스화 한 데이터 타입
